...
import (
	...
	intGetVersion "intmax2-store-vault/internal/use_cases/get_version"
	"intmax2-store-vault/internal/use_cases/mocks"
	"intmax2-store-vault/pkg/use_cases/get_version"
	"testing"
